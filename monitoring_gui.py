...
def monitoring_gui():
    ...
    mrn_combo_box.grid(column=0, row=1, columnspan=2, padx=(10, 10), pady=(0,10))
    # mrn_combo_box["values"] = get from API request
    
    name_label = ttk.Label(root, text="Patient Name")
    name_label.grid(column=2, row=0, pady=(10, 10))
    ...
    mrn_box.grid(column=4, row=1, padx=(10, 10))
    ...
    med_img_placeholder = load_and_resize_image("images/upj1.jpg", 0.2)
